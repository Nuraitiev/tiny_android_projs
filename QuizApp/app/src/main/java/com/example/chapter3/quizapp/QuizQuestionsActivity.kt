...
import com.example.chapter3.quizapp.databinding.ActivityQuizQuestionsBinding
...
class QuizQuestionsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userName = intent.getStringExtra(Constant.USER_NAME).toString()
        ...
        questionsList.addAll(Constant.questions)
        setQuestion()
            ...
            buttonSubmit?.id -> {
                if (selectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        intent.putExtra(Constant.CORRECT_ANSWERS, correctAnswers)
                        intent.putExtra(Constant.TOTAL_QUESTIONS, questionsList.size)
